...
export const metadata: Metadata = {
  ...
  description: "Generated by Gustavo Facco Cunha",
}
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      ...
      >
        <div className="mx-auto h-full min-h-screen w-[375px] max-w-full overflow-y-auto border border-zinc-700 shadow-lg [&::-webkit-scrollbar]:hidden">
          <AuthProvider>
